        ...
        >
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-10">
                                            ...
                                            (skill) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="h-1 overflow-hidden rounded-full bg-white/5">
                                                        <div
                                                            className={`h-full rounded-full bg-primary transition-all duration-700 group-hover/skill:shadow-[0_0_12px_rgba(141,255,105,0.5)] ${
                                                                skill.level ===
                                                                "Advanced"
                                                                    ? "w-[90%]"
                                                                    : skill.level ===
                ...
                <ScrollReveal delay={0.2}>
                    <div className="mt-12 flex flex-wrap items-center justify-center gap-x-8 gap-y-4 border-t border-white/10 pt-12">
                        {[
                            "React",
                            "JavaScript",
                            "Java",
                            ...
                            <span
                                key={tech}
                                className="text-sm text-white/30 transition-colors duration-300 hover:text-primary"
                            >
                                {tech}
                            </span>
                        ))}
